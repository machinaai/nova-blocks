          ...
          <div style={{
            ...
            {nameUser ? (
              <div className={styles.heading} style={{ fontFamily: font?.fontTitle }}>
                <p>
                  {`¡${intl.formatMessage({ id: 'BLOCK_NAME_CAMMEL_CASE.H_title' })}`}
                </p>
                <p>
                  {nameUser}!
            </p>
            ...
            <div className={styles.messageVirtual}>
              <p className={styles.txt} style={{ fontFamily: font?.fontSubtitle }}>
                {intl.formatMessage({ id: 'BLOCK_NAME_CAMMEL_CASE.H_subtitle' })}
              </p>
            </div>
            ...
            <div className={styles.wallet}>
              <p className={styles.cardLabel}>
                {intl.formatMessage({ id: 'BLOCK_NAME_CAMMEL_CASE.B_desc1' })}
              </p>
              {numberCard ? (
              ...
              >
                {intl.formatMessage({ id: 'BLOCK_NAME_CAMMEL_CASE.wallet_btn' })}
              </Button>
            </div>

            <div className={styles.sendMessage}>
              <p>{intl.formatMessage({ id: 'BLOCK_NAME_CAMMEL_CASE.B_desc2' })}</p>
            </div>
            <div className={styles.sendBtn}>
              <Button
                ...
                onClick={actionBtn}
              >
                {intl.formatMessage({ id: 'BLOCK_NAME_CAMMEL_CASE.text_btn' })}
              </Button>
            </div>
            <div className={styles.downloadContainer}>
              <p>
                {intl.formatMessage({ id: 'BLOCK_NAME_CAMMEL_CASE.F_title1' })}
            </p>
            ...
            <div className={styles.bottomWrapper2}>
              <p>
                {intl.formatMessage({ id: 'BLOCK_NAME_CAMMEL_CASE.F_title2' })}
            </p>
              {downStore}
            </div>
          </div>
