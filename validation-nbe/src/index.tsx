    ...
    >
      <div className={styles.userContainer}>
        <FormItem
          ...
          prefix={<UserOutlined />}
          name="newPassword"
          placeholder={useintl.formatMessage({ id: 'validationNbe.label.newpassword' })}
          maxLength={20}
          onPasteDisabled
          inputPassword
          ...
          rules={[
            {
              required: true,
              message: useintl.formatMessage({ id: 'validationNbe.input.empty' }),
            },
            {
              min: 3,
              message: useintl.formatMessage({ id: 'validationNbe.input.check' }),
            },
          ]}
        />
        <FormItem
          ...
          placeholder={useintl.formatMessage({ id: 'validationNbe.label.confirmpassword' })}
          maxLength={20}
          onPasteDisabled
          inputPassword
          className={equalPasswords && styles.equalPassword}
        ...
        <div className={styles.rulesContainer} id="rules">
          <span className={styles.rulesTitle}>
            {useintl.formatMessage({ id: 'validationNbe.label.rules' })}
          </span>
          <div className={styles.rule}>
            ...
            <p>{useintl.formatMessage({ id: 'validationNbe.label.rule-A' })}</p>
          </div>
          <div className={styles.rule}>
            {password.condition2 ? (
              <img src={check} alt="check" className={styles.checkedIcon} />
            ...
            <p>{useintl.formatMessage({ id: 'validationNbe.label.rule-B' })}</p>
          </div>
          <div className={styles.rule}>
            {password.condition3 ? (
              <img src={check} alt="check" className={styles.checkedIcon} />
            ...
            <p>{useintl.formatMessage({ id: 'validationNbe.label.rule-C' })}</p>
          </div>
          <div className={styles.rule}>
            {password.condition4 ? (
              <img src={check} alt="check" className={styles.checkedIcon} />
            ...
            <p>{useintl.formatMessage({ id: 'validationNbe.label.rule-D' })}</p>
          </div>
          <div className={styles.rule}>
            {password.condition5 ? (
              <img src={check} alt="check" className={styles.checkedIcon} />
            ...
            <p>{useintl.formatMessage({ id: 'validationNbe.label.rule-E' })}</p>
          </div>
        </div>
