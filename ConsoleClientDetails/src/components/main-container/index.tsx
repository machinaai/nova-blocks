 ...
 */
    ...
    const dataForm = {
        section1: {
            titleSection: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-title-sec1' })}`,
            fields: {
                col1: [
                    {
                        inputName: 'username',
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field1' })}:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field1' })}:`}
                            maxLength={100}
                    ...
                    {
                        inputName: 'lastname',
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field2' })}:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field2' })}:`}
                            maxLength={100}
                            onKeyPress={onlyLetters}
                            onPaste={disableCopyPaste}
                            onCopy={disableCopyPaste}
                    ...
                    },
                    {
                        ...
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field3' })}:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field3' })}:`}
                            maxLength={100}
                            onKeyPress={onlyLetters}
                            onPaste={disableCopyPaste}
                            onCopy={disableCopyPaste}
                ...
                col2: [
                    {
                        inputName: 'gender',
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field4' })}:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field4' })}:`}
                            maxLength={100}
                            onKeyPress={onlyLetters}
                            onPaste={disableCopyPaste}
                            onCopy={disableCopyPaste}
                    ...
                    {
                        inputName: 'birthday',
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field5' })}:`,
                        element:
                            <>
                                <DatePicker
                                    format='DD/MM/YYYY'
                    ...
                    },
                    {
                        ...
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field6' })}:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field6' })}:`}
                            maxLength={100}
                            onKeyPress={onlyLetters}
                            onPaste={disableCopyPaste}
                            onCopy={disableCopyPaste}
                    ...
                    {
                        inputName: 'curp',
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field7' })}:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field7' })}:`}
                            maxLength={100}
                    ...
                    {
                        inputName: 'ine',
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field8' })} INE/IFE:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field8' })} INE/IFE:`}
                            maxLength={100}
                            onPaste={disableCopyPaste}
                            onCopy={disableCopyPaste}
        ...
        section2: {
            titleSection: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-title-sec2' })}`,
            fields: {
                col1: [
                    {
                        inputName: 'street',
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field9' })}:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field9' })}:`}
                            maxLength={100}
                            onPaste={disableCopyPaste}
                            onCopy={disableCopyPaste}
                            onKeyPress={onlyLettersAndNumbers}
                    ...
                    },
                    {
                        ...
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field10' })}:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field10' })}:`}
                            maxLength={100}
                    ...
                    {
                        inputName: 'suburb',
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field11' })}:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field11' })}:`}
                            maxLength={100}
                            onKeyPress={onlyLettersAndNumbers}
                            onPaste={disableCopyPaste}
                            onCopy={disableCopyPaste}
                    ...
                    {
                        inputName: 'townhall',
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field12' })}:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field12' })}:`}
                            maxLength={100}
                            onKeyPress={onlyLetters}
                            onPaste={disableCopyPaste}
                            onCopy={disableCopyPaste}
                ...
                col2: [
                    {
                        inputName: 'cp',
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field13' })}:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field13' })}:`}
                            maxLength={100}
                            onKeyPress={onlyNumbers}
                            onPaste={disableCopyPaste}
                            onCopy={disableCopyPaste}
                    ...
                    {
                        inputName: 'city',
                        label: `${intl.formatMessage({ id: 'BLOCK_NAME.Form-field14' })}:`,
                        element: <Input
                            placeholder={`${intl.formatMessage({ id: 'BLOCK_NAME.Form-field14' })}:`}
                            maxLength={100}
                            onKeyPress={onlyLetters}
                            onPaste={disableCopyPaste}
                            onCopy={disableCopyPaste}
    ...
    const propsStep = {
        dataDocDetail: [
            ...
            {
                step: `${intl.formatMessage({ id: 'BLOCK_NAME.firm' })}`,
            ...
            <Col span={24}>
                <Row>
                    ...
                    <Col xs={24} md={8} xl={8}>
                        ...
                        <Button type='primary' size='large' style={{ width: '100%' }} htmlType='submit' onClick={getDataForm} >{intl.formatMessage({ id: 'BLOCK_NAME.Form-btn' })}</Button>
                        <Button href={`${pathBtnReturn}`} size='large' type="link" block >{intl.formatMessage({ id: 'BLOCK_NAME.Form-btn-return' })}</Button>
                    </Col>
                </Row>
            </Col>
        </Row>
