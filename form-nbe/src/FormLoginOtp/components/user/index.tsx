...
export interface LoginProps {
  ...
  onSubmit?: (values: FormLoginTypeOTP) => void;
  className?: string;
  from?: FormInstance;
...
interface LoginType extends React.FC<LoginProps> {
  ...
  UserKey: React.FunctionComponent<LoginItemProps>;
    ...
    >
      <div className={classNames(className, styles.login)}>
        <Form
          ...
          onFinish={(values) => {
            if (props.onSubmit) {
              props.onSubmit(values as FormLoginTypeOTP);
            }
          }}
        >
          {tabs.length ? (
...
Login.UserKey = LoginItem.UserKey;
